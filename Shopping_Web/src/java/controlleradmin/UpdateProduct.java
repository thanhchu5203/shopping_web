...
public class UpdateProduct extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            ProductDetail pd = dao1.getProductDetailByID(id);
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            dao.updateProduct(name, price, image, stock, des, status,dao1.getProductDetailByID(id).getProductDetailID(),id);
            dao1.updateProductDetail(id, size, color);
        } catch (NumberFormatException e) {
        }

<%-- 
    Document   : HomePage
    Created on : Mar 6, 2024, 7:44:32 PM
    Author     : Lewis
--%>
...
<html lang="zxx">
    <head>
        ...
        <!-- Title Tag  -->
        <title>LeWiss - Stussy shop</title>
        <!-- Favicon -->
    ...
    <body class="js">
        ...
        <section class="hero-slider">
            ...
            <div class="single-slider">
                <img class="image-slideshow" src="images/m2.jpg" alt="#">
            </div>
            <!--/ End Single Slider -->
        </section>
        <!--/ End Slider Area -->
                            ...
                            <div class="nav-main">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <c:forEach var="c" items="${requestScope.cate}">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="shop?id=${c.categoryID}" >${c.categoryName}</a>
                                        </li>
                                        </c:forEach>
                                </ul>
                                <!--/ End Tab Nav -->
